...
<head>
    ...
    <!-- =============== fonts awesome =============== -->
    <link rel="stylesheet" href="<?php echo base_url();?>assets/font/css/font-awesome.min.css" type="text/css">
    <!-- =============== Plugin CSS =============== -->
    ...
    <link href="<?php echo base_url();?>assets/owl-carousel/owl.theme.css" rel="stylesheet">
	 ...
	 <link rel="stylesheet" href="<?php echo base_url();?>assets/css/isotope-docs.css" media="screen">
	  <link rel="stylesheet" href="<?php echo base_url();?>assets/css/baguetteBox.css">
...
<body>
    ...
    <div id="preloader">
        <div id="loading">
		<img width="256" height="32" src="<?php echo base_url();?>assets/img/loading-cylon-red.svg">	
        </div>
    </div>
    <!-- =============== nav =============== -->
        ...
        <div class="container">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><img src="<?php echo base_url();?>assets/img/logo.png" alt="Logo">EVENTOS
                    </a>
                </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-6 wow fadeInDown animated" data-wow-delay=".5s">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-6 wow fadeInRight animated" data-wow-delay=".5s">
                     <img src="<?php echo base_url();?>assets/img/about-img.jpg"/>               
                  </div>     
            </div>
        </div>    -->
		<!-- =============== container end =============== -->		
          ...
          <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInDown animated" data-wow-delay=".1s">
              ...
              <!-- <span>Creative Director </span> -->
                  <ul class="social-links">
                    ...
                    <li><a data-wow-delay=".2s" class="wow fadeInUp animated" href="<?php echo base_url();?>index.php/evento/evento1"><i >OBTEN TU ENTRADA</i></a></li>
                  </ul>
            </div>
           </div>
...
<br>
            ...
            <div class="row">
				...
				<p>Meet some of our lovely, passionate, positive people.</p>
                 ...
                 <div class="col-xs-12 col-sm-4 col-md-4 wow fadeInUp animated" data-wow-delay=".1s">
                      <div class="blog-img">
						<img src="<?php echo base_url();?>assets/img/blog1.JPG"/>
					  </div>
					  <div class="row">
				 ...
				 <div class="col-xs-12 col-sm-4 col-md-4 wow bounceIn animated" data-wow-delay=".4s">
                      <div class="blog-img">
						<img src="<?php echo base_url();?>assets/img/blog2.JPG"/>
					  </div>
					  <div class="row">
					  <div class="data">30</div>
					  <div class="month">March</div>
					  ...
					  <h3>Travelling with kids Quensland Capricorn Coast</h3>
					  <p>Lorem ipsum dolor sit amet consectetur adipiscing elit. Vestibulum ac vehicula leo dulam nullam rhoncus tortor at dignissim vehicula.</p>
					  <a href="<?php echo base_url();?>blog-single.html">MORE</a>
					  </div>
                  </div>        
				 <div class="col-xs-12 col-sm-4 col-md-4 wow fadeInDown animated" data-wow-delay=".3s">
                      <div class="blog-img">
						<img src="<?php echo base_url();?>assets/img/blog3.JPG"/>
					  </div>
					  <div class="row">
					  <div class="data">30</div>
					  <div class="month">March</div>
    ...
    <div class="container">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
					...
					<ul class="social-links">
						<li><a class="wow fadeInUp animated" href="<?php echo base_url();?>index.html#" style="visibility: visible; animation-name: fadeInUp;"><i class="fa fa-facebook"></i></a></li>
    ...
    <script src="<?php echo base_url();?>assets/js/jquery.js"></script>
	 <script src="<?php echo base_url();?>assets/js/isotope-docs.min.js"></script>
...
<script src="<?php echo base_url();?>assets/js/baguetteBox.js" async></script>
<script src="<?php echo base_url();?>assets/js/plugins.js" async></script>
