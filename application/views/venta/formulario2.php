...
<br>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control col-sm-12" name='nombres' id="nombres"  placeholder="Ingrese Nombre" 
                                                                                    title="Ingrese nombre" required minlength="3"  maxlength="30"    pattern='[A-Za-z]{3,25}' value="<?php echo set_value('nombres');?>">
                                            </div>
                                            <div class="form-group"  >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control col-sm-12" title="Ingrese Carnet de Identidad" name='ci'  id="ci" placeholder="Ingrese C.I." required   minlength="4"  maxlength="12" is_unique:[usuario.ci] >
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">Telefono:</label>
                                                <input type="number" class="form-control col-sm-12" title="Ingrese Telefono" name='telefono' id='telefono'  placeholder="Ingrese telefono"  min="1"  pattern='^[0-9]+'   minlength="7"  maxlength="8"  required >
                                            </div>
                                            <div class="form-group">
